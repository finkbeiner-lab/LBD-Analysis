...
class SplitData:
    ...
    def copy_split_files_to_dataset(self, filenames, dst_directory, dst_type):
        ...
        '''
        for src_file in tqdm(filenames, bar_format="{l_bar}%s{bar}%s{r_bar}" % (Fore.BLUE, Fore.RESET)):
...
if __name__ == "__main__":
    ...
    base_WSI_path = "/gladstone/finkbeiner/steve/work/data/npsad_data/monika/LBD/generated_data_v2/"
