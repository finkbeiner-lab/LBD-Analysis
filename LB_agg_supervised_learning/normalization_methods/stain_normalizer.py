...
from Normalization.acd import ACDModel, acd_model  # Assuming you have the ACDModel defined as above
import pdb
...
class StainNormalizer(object):
    def __init__(self, pixel_number=100000, step=300, batch_size=1500,
        ...
        self.model = ACDModel(input_dim=3)
    ...
    def extract_adaptive_cd_params(self, images):
        ...
        #print(od_data.shape)
        input_od = torch.tensor(od_data, dtype=torch.float32)
