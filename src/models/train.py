...
if __name__ == '__main__':
    ...
    optim_config = dict(
        ...
        defaults=dict(lr=0.0001)  #-4 is too slow 
    )
    wandb_config = dict(
        project='LBD',
    ...
    #train_dataset = build_features.LBD_Dataset(dataset_train_location, T.Compose([T.ToTensor()]),["augmented_images1","augmented_labels1"])
    ...
    eval_metric_full_training.to_csv("/gladstone/finkbeiner/steve/work/data/npsad_data/monika/LBD/reports/validation_result.csv")
