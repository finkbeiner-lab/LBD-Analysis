...
class ExplainPredictions():
    ...
    def __init__(self, model, model_input_path, test_input_path, detection_threshold, wandb, save_result, ablation_cam, save_thresholds):
        ...
        self.class_to_colors = {'True': (255, 0, 0)}
        self.result_save_dir = "/gladstone/finkbeiner/steve/work/data/npsad_data/monika/LBD/Reports/figures/"
        
        self.colors = np.random.uniform(0, 255, size=(len(self.class_names), 1))
        print(self.colors)
        ...
        self.results_path = "/gladstone/finkbeiner/steve/work/data/npsad_data/monika/LBD/Reports/LB_output2"
        self.masks_path = "" 
    ...
    def generate_results_v1(self):
        ...
        for img in tqdm(images):
            ...
            if len(labels)>=1:
                ...
                cnt = cnt+1
                result_img_name = str(cnt) +  "_result.png"
        ...
        return detected_img_list, boxes_list
...
if __name__ == "__main__":
    ...
    explain = ExplainPredictions(model, model_input_path = model_input_path, test_input_path=input_path, 
                                    detection_threshold=0.75, wandb='', save_result=True, ablation_cam=False, save_thresholds=False)
