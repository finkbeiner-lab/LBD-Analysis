...
#SBATCH --job-name=clf      ## Name of the job
#SBATCH --output=clf3.out    ## Output file
...
cd /gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/codes/crop_based
python3 train_crop_classifer.py 
